...
const WALTTI_CONFIG = {
  ...
  'src': [
    ...
    src('Lappeenranta', 'https://gtfsdatav2.blob.core.windows.net/gtfsdata-blob/lappeenranta.zip', 'gtfs_shape_mapfit/fit_gtfs_stops.bash', ['router-waltti/gtfs-rules/waltti.rule']),
    src('Mikkeli', 'https://gtfsdatav2.blob.core.windows.net/gtfsdata-blob/mikkeli.zip', 'gtfs_shape_mapfit/fit_gtfs_stops.bash', ['router-waltti/gtfs-rules/waltti.rule']),
    src('PohjoisPohjanmaanEly', 'https://gtfsdatav2.blob.core.windows.net/gtfsdata-blob/pohjois-pohjanmaan_ely.zip', 'gtfs_shape_mapfit/fit_gtfs_stops.bash', ['router-waltti/gtfs-rules/waltti.rule']),
    src('IisalmiEly', 'https://gtfsdatav2.blob.core.windows.net/gtfsdata-blob/posely_iisalmi.zip', 'gtfs_shape_mapfit/fit_gtfs_stops.bash', ['router-waltti/gtfs-rules/waltti.rule']),
    src('MikkeliEly', 'https://gtfsdatav2.blob.core.windows.net/gtfsdata-blob/posely_mikkeli.zip', 'gtfs_shape_mapfit/fit_gtfs_stops.bash', ['router-waltti/gtfs-rules/waltti.rule']),
    src('Vaasa', 'https://gtfsdatav2.blob.core.windows.net/gtfsdata-blob/vaasa.zip', 'gtfs_shape_mapfit/fit_gtfs_stops.bash', ['router-waltti/gtfs-rules/waltti.rule']),
    src('Joensuu', 'https://gtfsdatav2.blob.core.windows.net/gtfsdata-blob/joensuu.zip', 'gtfs_shape_mapfit/fit_gtfs_stops.bash', ['router-waltti/gtfs-rules/waltti.rule']),
    src('JoensuuEly', 'https://gtfsdatav2.blob.core.windows.net/gtfsdata-blob/posely_joensuu.zip', 'gtfs_shape_mapfit/fit_gtfs_stops.bash', ['router-waltti/gtfs-rules/waltti.rule']),
    ...
    src('LINKKI', 'http://jakoon.jkl.fi/reittiopas/datajkl.zip', 'gtfs_shape_mapfit/fit_gtfs_stops.bash'),
    src('tampere', 'http://www.tampere.fi/ekstrat/ptdata/tamperefeed_deprecated.zip', false),
    src('Rovaniemi', 'https://gtfsdatav2.blob.core.windows.net/gtfsdata-blob/rovaniemi.zip', 'gtfs_shape_mapfit/fit_gtfs_stops.bash', ['router-waltti/gtfs-rules/waltti.rule'])
  ],
  'osm': 'finland',
  'dem': 'waltti'
}
